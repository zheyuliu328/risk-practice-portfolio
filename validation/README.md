...
- Credit/ALM independent review used Decimal arithmetic for ECL movement and 300 seeded ALM scenarios, checking principal conservation and NII consistency.
- Controls independent review checked 1,458 capacity combinations, 25 PSI references, 36 AI combinations and 9 invalid numeric cases. Unknown labels remain unknown; AI checks never grant approval.
- Market tests include hand references and 4,950 empirical-CDF boundary combinations. Fractional ES tail mass, available collateral and required calls remain distinct.
- Detailed assumptions accompany exported results. Hand-calculation and software tests apply to the stated simplifications, not complete accounting, regulatory or production systems.

External human adoption, interview mastery and end-to-end source-system integration remain unverified. Independent existing projects retain their own dated evidence; this release does not imply they were all rerun.

## Archived first integrated release
